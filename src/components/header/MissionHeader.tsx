...
export const MissionHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 select-none shrink-0 shadow-xl">
      ...
      <div className="h-6 bg-[#090d14] border-b border-amber-500/20 px-3 flex items-center justify-between text-[10px] font-mono shrink-0 overflow-x-auto no-scrollbar">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 rounded-sm bg-transparent hover:bg-slate-800 text-amber-400/90 border border-slate-800 text-[10px] transition-colors"
          >
      ...
      <div className="bg-[#111722] border-b border-slate-800 px-4 py-2 backdrop-blur flex items-center justify-between gap-4">
        
        {/* Left: Brand & Incident Title */}
        <div className="flex items-center gap-3 shrink-0">
          <div className="relative flex items-center justify-center w-8 h-8 rounded-sm bg-slate-800/80 border border-slate-700 text-cyan-400">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-1.5 py-0.5 text-[9px] font-semibold tracking-wider uppercase rounded-sm bg-slate-800/90 text-cyan-300 border border-slate-700">
                INSARAG TIER-1
              </span>
            </div>
        ...
        <div className="flex items-center gap-3 shrink-0 font-mono text-xs">
          ...
          <div className="flex lg:hidden items-center gap-2 bg-[#0b101b] border border-slate-800 rounded-sm px-2 py-1 text-[11px]">
